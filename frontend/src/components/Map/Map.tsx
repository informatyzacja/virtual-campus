...
let markerReference: L.Marker;
let circleReference: L.Circle;
...
function startGeoLocation(reference: L.Map) {
  reference
...
function stopGeoLocation(reference: L.Map) {
  reference.stopLocate();
